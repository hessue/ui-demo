...
namespace BlockAndDagger.UI
{
    public sealed class MainMenuUI : MonoBehaviour
    {
        ...
        [Inject]
        public void Construct(IMenuFacade menuFacade)
        {
        ...
        {
            m_customizeButton.onClick.AddListener(OnCustomizeClicked);
        ...
        {
            m_customizeButton.onClick.RemoveListener(OnCustomizeClicked);
